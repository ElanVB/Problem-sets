...
public class Quick 
{
	...
	private static void quicksort(Comparable<Object>[] array, int start, int end)
	{
		if(start >= end) return;
	...
	private static int partition(Comparable<Object>[] array, int start, int end)
	{
		int pivot = end;
	...
	private static int median(Comparable<Object>[] array, int start, int end)
	{
	...
	private static void swap(Comparable<Object>[] array, int index1, int index2)
	{
		if (index1 == index2) return;
		
		Object temp = array[index1];
		array[index1] = array[index2];
		array[index2] = (Comparable<Object>) temp;
	}
}
